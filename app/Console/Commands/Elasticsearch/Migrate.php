...
class Migrate extends Command
{
     ...
     * @param  object $indexClass 索引类  
     * @return mixed 
     */
    private function createIndex($aliasName, $indexClass)
    {
        # 调用 create() 方法创建索引
    ...
    /**
     * 更新已有索引
     * @param  string $aliasName 索引名称
     * @param   $indexClass [description]
     * @return [type]             [description]
     */
    private function updateIndex($aliasName, $indexClass) 
    {
        // 暂时关闭索引
